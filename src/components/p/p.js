                                        ...
                                        <div class="flip-card1">
                                            <div class="flip-card-inner1">
                                                <div class="flip-card-front1">
                                                    ...
                                                    <br /><b class="size1">Size:</b> {d.SKU_ATTRIBUTE_VALUE1}<br /><b class="size1">Colour:</b> {d.SKU_ATTRIBUTE_VALUE2} <br /><b class="size1">Price:</b><b class="size2"> ₹ {d.LIST_PRICE*100}</b><br /><center><font color="white"><b>{d.DISCOUNT=='0.0'  || d.DISCOUNT==null?<div></div>:<div class="mf">{(d.DISCOUNT)*100} % off</div>} </b></font></center>
